    ...
    public sealed class AdHandlerController
    {
...
#endif
        {
            try
            {
                ...
                {
                    if (!await ActiveHandler.CancelAd())
                    {
                ...
                var cancellationTokenSource = CancellationTokenSource.CreateLinkedTokenSource(cancellationToken, timeoutToken);
        ...
        public async void CancelActiveAds()
        {
            if (ActiveHandler != null)
            {
                await ActiveHandler.CancelAd();
            }
        }
