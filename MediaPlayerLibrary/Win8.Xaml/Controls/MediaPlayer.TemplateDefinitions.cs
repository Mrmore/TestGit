...
namespace Microsoft.PlayerFramework
{
    ...
    {
        const int MaxPlaybackRate = 32;
        const int MinPlaybackRate = -32;
        ...
        /// <summary>
        /// Gets the default InteractiveViewModel. This default viewmodel and is always retained even after InteractiveViewModel is set.
        /// </summary>
        public IInteractiveViewModel DefaultInteractiveViewModel { get; private set; }
        #endregion
 ...
 || interactiveElements.Any(ie => ie.HasKeyboardFocus())
                || (PlayToSource != null && PlayToSource.Connection != null && PlayToSource.Connection.State != PlayToConnectionState.Disconnected)
#endif
);
