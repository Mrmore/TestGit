using System;
using DataLayerWrapper.Notifications.BadgeContent;
#if !WINRT_NOT_PRESENT
using Windows.Data.Xml.Dom;
using Windows.UI.Notifications;
#endif

namespace DataLayerWrapper.Notifications
{
    /// <summary>
    ...
    public sealed class BadgeNumericNotificationContent : IBadgeNotificationContent
    {
        ...
        /// <summary>
        /// Constructor to create a numeric badge content object with a xml string.
        /// </summary>
        /// <param name="xml">
        ...
        /// </param>
        public BadgeNumericNotificationContent(string xml)
        {
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(xml);
            var badge = doc.DocumentElement;
            var number = badge.GetAttribute("value");
            this.m_Number = Convert.ToUInt32(number ?? "0");
        }
