    ...
    public sealed class AccelerometerHelper: IDisposable
    {
        ...
        private AccelerometerHelper()
        {
            ...
            else
            {
                ...
                _sensor.ReportInterval = minReportInterval > 16 ? minReportInterval : 16;
                //
                NoAccelerometer = false;//(_sensor.State == SensorState.NotSupported);
            }
            _sensor = null;
        ...
        private void sensor_ReadingChanged(Accelerometer sender, AccelerometerReadingChangedEventArgs e)
        {
